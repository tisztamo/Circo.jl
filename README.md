...
*WARNING: Circo is in its infancy, not yet useful for real projects. It may seem dormant while undergoing full rewrite, as the code is splitted into different repos (mainly [CircoCore](https://github.com/Circo-dev/CircoCore), [CircoCore.js](https://github.com/Circo-dev/CircoCore.js) and [Plugins.jl](https://github.com/tisztamo/Plugins.jl)).
